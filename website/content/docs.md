...
NOTE: The above uses Roc [alpha4](https://github.com/roc-lang/roc/releases/tag/alpha4-rolling) (stable Rust compiler). Some of the syntax is deprecated and will not work with the new Zig compiler. If you would like to experiment with the unstable Zig compiler, you can try [this guide](https://github.com/roc-lang/roc/blob/main/docs/mini-tutorial-new-compiler.md).
