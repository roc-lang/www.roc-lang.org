...
<section class="home-goals-container" aria-label="Roc's Design: Fast, Friendly, Functional">
    <div role="presentation" class="home-goals-column">
        <a href="/fast" class="home-goals-content">
            ...
            <p class="home-goals-description">Roc is designed to build fast and <span class="nowrap">run fast</span>. Produce machine code or WebAssembly.</p>
            <p class="home-goals-learn-more">Learn more</p>
        </a>
    </div>
    <div role="presentation" class="home-goals-column">
        <a href="/friendly" class="home-goals-content">
            <h3 class="home-goals-title">Friendly</h3>
            <p class="home-goals-description">User-friendly language, toolset, and community</p>
            <p class="home-goals-learn-more">Learn more</p>
        </a>
    </div>
    <div role="presentation" class="home-goals-column">
        <a href="/functional" class="home-goals-content">
            ...
            <p class="home-goals-description">
             A small number of simple language primitives. A single-paradigm <span class="nowrap">functional language.</span></p>
            <p class="home-goals-learn-more">Learn more</p>
        </a>
    </div>
</section>
...
<div id="homepage-repl-container" role="presentation">
    <div id="repl-description" role="presentation">
        <p>Roc can run standalone in the browser using <a href="https://webassembly.org">WebAssembly</a>.</p>
...
Roc is a young language. However, it can already be used for several things if you're up for being an early adopter—
with the bugs and missing features which come with that territory.
...
<p id="donate-p">
  <a class="btn-small" href="/donate">Donate</a>
</p>
