// Vendored from fzstd v0.1.1 (https://github.com/101arrowz/fzstd), MIT License,
// Copyright (c) 2020 Arjun Barrett. Vendored (not npm-installed) to keep this
// static site free of a package-manager dependency. Only `decompress` is used,
// to inflate the .zst-compressed echo.wasm compiler asset in the browser.
